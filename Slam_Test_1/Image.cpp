...
void Compare_Image(Image oSource, Image oDest, int iDiff_Threshold)
{
...
void Compare_Image(char* pcSource, char* pcDest,int iDiff_Threshold)
{
	Image oSource, oDest;
	...
	Free_Image(&oSource);
	Free_Image(&oDest);
	Compare_Image(oSource, oDest,iDiff_Threshold);
	return;
}
